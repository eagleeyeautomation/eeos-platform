      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-4 pt-20 pb-16">
        ...
        <div
          className={`w-24 h-24 rounded-full flex items-center justify-center mb-8 transition-all duration-700 ${
            allDone
              ? "bg-[rgba(0,212,200,0.12)] border-2 border-[#00D4C8] shadow-[0_0_40px_rgba(0,212,200,0.3)]"
        ...
        <div className="w-full max-w-md mb-12">
          <div className="glass-card rounded-xl p-6">
            ...
            {allDone && (
              <div className="mt-5 pt-4 border-t border-[rgba(0,212,200,0.1)]">
        ...
        {allDone && (
          <div className="w-full max-w-3xl">
            <p className="text-center text-sm text-[#E8EDF5]/40 mb-6"
              style={{ fontFamily: "'JetBrains Mono', monospace" }}>
              WHAT TO DO NEXT
            </p>
              ...
              {NEXT_STEPS.map((step, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-xs text-[#E8EDF5]/50 leading-relaxed">{step.description}</div>
                  </div>
