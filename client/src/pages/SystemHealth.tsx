...
const INCIDENT_STATUS = {
  ...
  monitoring: { label: "Monitoring", color: "#00D4C8" },
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 space-y-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            { label: "Avg Response", value: "47ms", color: "#00D4C8", icon: Zap },
        ...
        <div>
          ...
          <div className="space-y-2">
            {SYSTEM_COMPONENTS.map((comp) => {
              ...
              return (
                <div key={comp.name} className="flex items-center gap-4 px-5 py-4 rounded-xl glass-card hover:border-[rgba(0,212,200,0.2)] transition-all duration-200">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5">
                      <span className="text-sm font-semibold text-[#E8EDF5]" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                        {comp.name}
                      </span>
                      <span className="text-[9px] px-1.5 py-0.5 rounded bg-[rgba(0,212,200,0.06)] text-[#00D4C8]/60 border border-[rgba(0,212,200,0.1)]" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
                        {comp.category}
                      </span>
                    </div>
                    <div className="text-xs text-[#E8EDF5]/40">{comp.description}</div>
                  </div>
                  ...
                  <div className="hidden sm:flex items-center gap-6 shrink-0">
                    ...
                    <div className="text-right">
                      <div className="text-[10px] text-[#E8EDF5]/30 mb-0.5" style={{ fontFamily: "'JetBrains Mono', monospace" }}>RESPONSE</div>
          ...
          <div className="glass-card rounded-2xl p-6">
            ...
            <ResponsiveContainer width="100%" height={160}>
              <BarChart data={UPTIME_DATA} barSize={28}>
                ...
                <Tooltip contentStyle={{ background: "#0F1E35", border: "1px solid rgba(0,212,200,0.2)", borderRadius: "8px", fontSize: "11px" }} formatter={(v: number) => [`${v}%`, "Uptime"]} />
                <Bar dataKey="uptime" fill="#00D4C8" radius={[4, 4, 0, 0]} fillOpacity={0.8} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        ...
        <div className="glass-card rounded-2xl p-6">
          ...
          <div className="space-y-4">
            {INCIDENTS.map((inc) => {
              ...
              return (
                <div key={inc.id} className="flex items-start gap-4 p-4 rounded-xl bg-[rgba(0,0,0,0.2)] border border-[rgba(0,212,200,0.06)]">
                  <div
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-3 mb-1">
                      <div>
                        ...
                        <span className="ml-2 text-[10px] text-[#E8EDF5]/30" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
                          {inc.id}
                        </span>
                      </div>
                      <span
                    ...
                    <div className="text-xs text-[#E8EDF5]/50 mb-1">{inc.impact}</div>
                    <div className="flex items-center gap-3 text-[10px] text-[#E8EDF5]/30" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
                      <span>{inc.date}</span>
                      <span>·</span>
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-[rgba(0,212,200,0.08)]">
          <Link href="/integration-health" className="inline-flex items-center justify-center gap-2 px-6 py-3 text-sm font-semibold text-[#050C1A] bg-[#00D4C8] rounded-lg hover:bg-[#00E8DB] active:scale-[0.97] transition-all duration-200 shadow-[0_0_20px_rgba(0,212,200,0.35)]" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
            <Activity className="w-4 h-4" />
            View Integration Health
          </Link>
          <Link href="/executive-home" className="inline-flex items-center justify-center gap-2 px-6 py-3 text-sm font-semibold text-[#00D4C8] border border-[rgba(0,212,200,0.35)] rounded-lg hover:bg-[rgba(0,212,200,0.08)] active:scale-[0.97] transition-all duration-200" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
